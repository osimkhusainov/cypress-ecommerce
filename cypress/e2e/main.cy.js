...
describe('Main page with an invalid item', () => {
  ...
  // This is Frontend bug, with mock data backend is returning 404 status, but frontend is showing an infinity loader
  it('Should see the 404 error page if an item not found', () => {
